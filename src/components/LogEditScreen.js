...
const LogEditScreen = ({history}) => {
    ...
    return (
        ...
        <h1>Edit Solution</h1>
        <Form onSubmit={validator.isURL(solutionLink) || solutionLink === '' ? submitHandler : () => {
            showAlert(setAlert,'Enter valid URL as a solution','danger')
        }}>
            <Card className='my-2 p-2'>
            <Card.Img src={`http://localhost:5000${imagePath.replace(/\\/g, "/")}`} alt={text} style={{height: '500px'}}/>
            </Card>
            <Form.Group controlId='priority'>
                <Form.Label>Priority</Form.Label>
                <Form.Control type='text' placeholder='Priority'
                value={priority.charAt(0).toUpperCase() + priority.slice(1)} onChange={(e) => setPriority(e.target.value)} readOnly>
                </Form.Control>
            </Form.Group>

            <Form.Group controlId='logtitle'>
                <Form.Label>Log Title</Form.Label>
                <Form.Control type='text' placeholder='Log Title'
                value={text.charAt(0).toUpperCase() + text.slice(1)} onChange={(e) => setText(e.target.value)} readOnly>
                </Form.Control>
            </Form.Group>
            ...
            <Form.Label>Description</Form.Label>
                ...
                value={description} onChange={(e) => setDescription(e.target.value)} readOnly>
                </Form.Control>
            </Form.Group>
            ...
            <Form.Label>Platform</Form.Label>
                ...
                value={platform.charAt(0).toUpperCase() + platform.slice(1)} onChange={(e) => setPlatform(e.target.value)} readOnly>
                </Form.Control>
            </Form.Group>

            <Form.Group controlId='logger'>
            <Form.Label>Logger</Form.Label>
                <Form.Control type='text' placeholder='logger'
                value={logger.charAt(0).toUpperCase() + logger.slice(1)} onChange={(e) => setLogger(e.target.value)} readOnly>
                </Form.Control>
            </Form.Group>

            <Form.Group controlId='created'>
                <Form.Label>Created At</Form.Label>
                <Form.Control type='text' placeholder='created at'
                value={created.substring(0,10)} onChange={(e) => setCreated(e.target.value)} readOnly>
                </Form.Control>
            </Form.Group>

            <Form.Group controlId='solutionlink'>
                <Form.Label>Solution Link</Form.Label>
                <Form.Control type='text' placeholder='Enter Solution URL'
            ...
            <Form.Group controlId='solution' className='my-3'>
                ...
                <Form.Control as='textarea' rows='6' cols='70' value={solution} onChange={(e) => setSolution(e.target.value)}></Form.Control>
            </Form.Group>
